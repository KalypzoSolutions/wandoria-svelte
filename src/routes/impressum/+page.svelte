<section class="container flex flex-col md:flex-row gap-8">
    <div class="">
        <div class="sticky top-10 px-4 py-2">
            <a href="/" class="text-zinc-200">Zurück zur Hauptseite</a>        
        </div>
    </div>
	<div class="prose prose-invert">		
		<div class="mt-8">
			...
			<p>
				Johannes Schloter Software Entwicklung<br />
				Otto-Hahn-Str. 7<br />
				42579 Heiligenhaus <br />
			</p>
			<p>
				<strong>Vertreten durch: </strong><br />
				Johannes Schloter<br />
			</p>
			<p>
				<strong>Kontakt:</strong> <br />
				Telefon: 49 15563-121153<br />
				E-Mail: <a href="mailto:wandoria.webseite@einjojo.it">wandoria.webseite@einjojo.it</a>
				<br />
			</p>
			<p>
				...
				wir gemäß § 7 Abs.1 DDG für eigene Inhalte auf diesen Seiten nach den allgemeinen Gesetzen verantwortlich.
			...
			<a href="https://www.kanzlei-hasselbach.de/standorte/bonn/" rel="nofollow"
				>Kanzlei Hasselbach, Bonn</a
			>
		</div>
	</div>
</section>
