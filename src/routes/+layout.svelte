	...
	<nav class="container">
		<div class="flex items-center justify-between py-4">
			<div class="flex items-center gap-4">
				<div class="w-12 h-12">
					<img src="./assets/w.png" alt="logo" class="w-12 h-12">
				</div>                
			</div>
			<div class="flex items-center gap-4">                
				<a href="https://wandoria.net" class="dark:text-zinc-200">Main Page</a>
				<a href="https://dc.wandoria.net" class="dark:text-zinc-200">Discord</a>
				<a href="#discord" class="flex items-center gap-2 bg-emerald-400 px-4 py-2 rounded-md text-zinc-950 copy-ip cursor-pointer">					
